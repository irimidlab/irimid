...
SUBNASALE: Final[int] = 2
LEFT_BROW_INNER: Final[int] = 107
RIGHT_BROW_INNER: Final[int] = 336
...
ANTHROPOMETRIC_REFERENCES: Final[dict[str, dict[str, float]]] = {
    "upper_third_ratio": {"min": 0.26, "ideal": 0.33, "max": 0.40},
    "middle_third_ratio": {"min": 0.28, "ideal": 0.34, "max": 0.40},
    "lower_third_ratio": {"min": 0.28, "ideal": 0.33, "max": 0.40},
    "face_width_height": {"min": 0.65, "ideal": 0.80, "max": 0.95},
    "nose_width_face": {"min": 0.20, "ideal": 0.25, "max": 0.32},
    "mouth_width_face": {"min": 0.38, "ideal": 0.50, "max": 0.58},
    "interpupillary_face": {"min": 0.40, "ideal": 0.46, "max": 0.52},
    "eye_spacing": {"min": 0.26, "ideal": 0.32, "max": 0.38},
    "jaw_zygoma": {"min": 0.72, "ideal": 0.85, "max": 0.98},
    "upper_lower_lip": {"min": 0.38, "ideal": 0.45, "max": 0.58},
}
